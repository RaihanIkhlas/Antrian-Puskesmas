...
<head>
    ...
    <link rel="shortcut icon" href="views/admin/pkm.png">
...
<div class="message warning">
    <div class="inset">
        <div class="login-head" style="">
            <h1><img src="<?php echo base_url('assets/user')?>/img/pkm.png" alt=""  width="80" height=
      "80" style="float: left; margin-top: -25px;">Login Admin</h1>
